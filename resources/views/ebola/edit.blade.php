...
<div class="bg-[#02050f] text-slate-100 min-h-screen relative overflow-hidden">
    ...
    <div class="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 z-10">
        ...
        <div class="mb-8">
            ...
            <h2 class="text-2xl font-black text-white tracking-tight">Edit Patient Case File: {{ $case->patient_name }}</h2>
            <p class="text-xs text-slate-400 mt-1">Modify status, diagnostic tests, or quarantine placement for this patient record.</p>
        </div>
            ...
            <form action="{{ route('ebola.update', $case->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            <label for="health_institution_id" class="block text-[10px] font-bold text-slate-400 uppercase tracking-wider font-mono mb-2">MCH Facility</label>
