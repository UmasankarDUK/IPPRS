            ...
            <nav class="flex-1 overflow-y-auto py-3 px-2 space-y-0.5">
                ...
                <a href="{{ route('plans.index') }}"
                   class="nav-link {{ request()->routeIs('plans.*') ? 'active' : '' }}">
                    ...
                    <span x-show="sidebarOpen" class="label">Digital Plan</span>
                </a>
                ...
                <a href="{{ route('ebola.index') }}"
                   class="nav-link {{ request()->routeIs('ebola.*') ? 'active' : '' }}">
                    ...
                    @if(request()->routeIs('ebola.*') && !request()->routeIs('ebola.report.*'))
                        <span x-show="sidebarOpen" class="ml-auto w-2 h-2 rounded-full bg-red-500 pulse-dot flex-shrink-0"></span>
                    @endif
                </a>

                <a href="{{ route('ebola.report.create') }}"
                   class="nav-link {{ request()->routeIs('ebola.report.*') ? 'active' : '' }}">
                    <svg class="icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>
                    </svg>
                    <span x-show="sidebarOpen" class="label">Daily Report Entry</span>
                </a>
        ...
        <aside x-show="mobileOpen"
            ...
            <nav class="flex-1 overflow-y-auto py-3 px-2 space-y-0.5">
                ...
                <a href="{{ route('plans.index') }}" class="nav-link {{ request()->routeIs('plans.*') ? 'active' : '' }}">
                    ...
                    <span class="label">Digital Plan</span>
                </a>
                ...
                <a href="{{ route('ebola.report.create') }}" class="nav-link {{ request()->routeIs('ebola.report.*') ? 'active' : '' }}">
                    <svg class="icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>
                    </svg>
                    <span class="label">Daily Report Entry</span>
                </a>
            </nav>
        </aside>
